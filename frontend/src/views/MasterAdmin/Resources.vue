  ...
  <div class="section">
    ...
    <div class="dashboard-header-modern mb-4 p-4 rounded shadow-sm bg-white">
      <div>
        ...
        <p class="text-muted mb-0">Configure and manage all campus resources and facilities.</p>
      </div>
      <div class="text-end d-none d-md-block">
        <span class="badge bg-light-teal text-teal p-2 px-3 rounded-pill border border-teal-subtle">
          <i class="bi bi-collection me-1"></i> {{ resourceStore.resources.length }} Total
        </span>
      </div>
    </div>
