  ...
  <div class="section">
    ...
    <div class="dashboard-header-modern mb-4 p-4 rounded shadow-sm bg-white no-print">
      <div>
        ...
        <h2 class="mb-0 fw-bold text-dark-teal">Resource Analytics</h2>
        <p class="text-muted mb-0">View usage statistics and booking reports for your resources.</p>
      </div>
      <div class="text-end d-none d-md-block">
        <span class="badge bg-light-teal text-teal p-2 px-3 rounded-pill border border-teal-subtle">
          <i class="bi bi-graph-up-arrow me-1"></i> {{ filteredBookings.length }} Bookings
        </span>
      </div>
    </div>
